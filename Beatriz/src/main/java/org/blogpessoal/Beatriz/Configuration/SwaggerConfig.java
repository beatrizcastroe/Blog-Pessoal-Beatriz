package org.blogpessoal.Beatriz.Configuration;
...
public class SwaggerConfig {
	...
	private static Contact contact() {
		return new Contact("Beatriz Castro", "https://github.com/beatrizcastroe",
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - Blog Pessoal").description("Projeto API Spring - Blog Pessoal")
				...
				.licenseUrl("https://github.com/beatrizcastroe/Blog-Pessoal-Beatriz").contact(contact()).build();
	}
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("org.blogpessoal.Beatriz.Controller"))
